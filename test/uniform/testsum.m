...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% File Name: testsum.m (uniform)                                     %%%
%%% This example tests the sum overloading operator, the results       %%%
