...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if size(a,1)==1 && size(a,2)==1
        ...
        if size(b,1)==1 && size(b,2)==1
            ...
            %if b is not a scalar we should perfrom an inverse
            %we cannot support matrix inversion if matrix include pct
            %values
            
            %to check: in reality marix could be of only duble
            error('Matrix inversion for pct types not supported jet')  
        end
